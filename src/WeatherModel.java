...
public class WeatherModel {
	...
	public void setArrayList(String airport, String date) throws IOException {
		...
		try {
			...
			URL u = new URL(URL1 + airport + SLASH + date + URL2);
	...
	private int flag = 0;
	private final String URL1 = "http://www.wunderground.com/history/airport/";
	private final String URL2 = "/DailyHistory.html?HideSpecis=1&format=1";
